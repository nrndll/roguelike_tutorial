...
class GameMap:
    def __init__(self, width, height):
        ...
        # in this case the array will use the width and height parameters from the initialiser and will be filled with wall tiles.
        # map will initially be populated with wall tiles and rooms will be carved out with floor tiles.
